...
/**
 * Implementacion del servicio de calculo de pedido peninsular
 * 
 * @author nandi
 *
 */
@Service("PenOrder")
public class CalculatePenOrderServiceImpl extends CalculateOrderServiceImpl implements OrderManagmentServiceI {
